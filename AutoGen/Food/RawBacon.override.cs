...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "RawBacon" item. 
    ...
    [LocDisplayName("Raw Bacon")] // Defines the localized name of the item.
    [Weight(250)] // Defines how heavy the RawBacon is.
    [Ecopedia("Food", "Raw Meat", createAsSubPage: true)]
    [LocDescription("A fatty cut of meat that happens to be inexplicably tastier than other cuts.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RawBacon".</para>
    ...
    [Ecopedia("Food", "Raw Meat", subPageName: "Raw Bacon Item")]
    public partial class RawBaconRecipe : RecipeFamily
    {
        public RawBaconRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(RawPorkChopItem), 3, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawBaconRecipe), start: 0.8f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Raw Bacon"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Raw Bacon"), recipeType: typeof(RawBaconRecipe));
