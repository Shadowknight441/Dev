...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IceboxRecipe : RecipeFamily
    {
        public IceboxRecipe()
        {
            ...
            recipe.Init(
                name: "Icebox",  //noloc
                displayName: Localizer.DoStr("Icebox"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IceboxRecipe), start: 2, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Icebox"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Icebox"), recipeType: typeof(IceboxRecipe));
            this.ModsPostInitialize();
