...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side animal entity definition for "Agouti".</para>
    ...
    public class Agouti : AnimalEntity
    {
        ...
        /// <summary>
        /// <para>Server side species definition for "Agouti".</para>
        ...
        public class AgoutiSpecies : AnimalSpecies
        {
            public AgoutiSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Agouti); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "Agouti"; //noloc
                this.DisplayName = Localizer.DoStr("Agouti");
                this.DisplayDescription = Localizer.DoStr("A small brownish rodent with sharp incisors that help them crack open hard seeds and fruits, allowing them to play an important role in seed dispersal.");
                ...
                {
                    new SpeciesResource(typeof(AgoutiCarcassItem), new Range(1, 1)),
                    new SpeciesResource(typeof(BabyAgoutiItem), new Range(0.0f, 0.75f)),
                };
