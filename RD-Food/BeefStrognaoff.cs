...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BeefStroganoff" item. 
    ...
    [LocDisplayName("Beef Stroganoff")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the BeefStroganoff is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Just because Beef is in the name, doesn't mean it's just a collection of red meat thrown in with mushrooms. Enjoy!")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BeefStroganoff".</para>
    ...
    public partial class BeefStroganoffRecipe : RecipeFamily
    {
        public BeefStroganoffRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Beef Stroganoff"
