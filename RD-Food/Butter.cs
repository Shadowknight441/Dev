...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Tallow" item. 
    ...
    [LocDisplayName("Butter")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Tallow is.
    [Fuel(2000)][Tag("Fuel")] // Marks the Tallow as fuel item.
    [Tag("Fat")]
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Made from the milk of a cow or goat.")] //The tooltip description for the food item.
    public partial class ButterItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 0, Fat = 8, Protein = 5, Vitamins = 0};
