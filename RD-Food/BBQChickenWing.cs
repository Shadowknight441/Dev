...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BakedBeans" item. 
    ...
    [LocDisplayName("BBQ Chicken Wing")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the BakedBeans is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Some Good Ole Tasty Chicken Wings")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BakedBeans".</para>
