...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Jumbalaya" item. 
    ...
    [LocDisplayName("Jumbalaya")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the Jumbalaya is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Bringing Cajun cooking straight to you!")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Jumbalaya".</para>
    ...
    public partial class JumbalayaRecipe : RecipeFamily
    {
        public JumbalayaRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Jumbalaya"
