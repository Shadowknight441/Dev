...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BeetDip" item. 
    ...
    [Weight(1)] // Defines how heavy the BeetDip is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("A light snack to tide you over till your next meal.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BeetDip".</para>
        ...
        public BeetDipRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                   ...
                   //new IngredientElement(typeof(BeetDipItem), 2, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Beet Dip"
