...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "FishBurger" item. 
    ...
    [LocDisplayName("Fish Burger")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the FishBurger is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Fish Burger, Please Enjoy!")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FishBurger".</para>
    ...
    public partial class FishBurgerRecipe : RecipeFamily
    {
        public FishBurgerRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "FishBurger"
