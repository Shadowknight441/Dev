...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "MeatDumplings" item. 
    ...
    [LocDisplayName("Meat & Dumplings")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the MeatDumplings is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("It's in the name. Just don't ask about what kind of meat it is!")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MeatDumplings".</para>
    ...
    [Ecopedia("MeatDumplings", "Cooking", subPageName: "Meat Dumplings Item")]
    public partial class MeatDumplingsRecipe : RecipeFamily
    {
        public MeatDumplingsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "MeatDumplings",  //noloc
                displayName: Localizer.DoStr("Meat & Dumplings"),
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(50, typeof(AdvancedCookingSkill));

            // Defines our crafting time for the recipe
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MeatDumplingsRecipe), start: 3.0f, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "MeatDumplings"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Meat & Dumplings"), recipeType: typeof(MeatDumplingsRecipe));
