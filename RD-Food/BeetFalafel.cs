...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BeetFalafel" item. 
    ...
    [LocDisplayName("Beet Falafel")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the BeetFalafel is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("A collectin of colors the realy shout 'I have all the carbs and fat your desire'!")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BeetFalafel".</para>
    ...
    public partial class BeetFalafelRecipe : RecipeFamily
    {
        public BeetFalafelRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Beet Falafel"
