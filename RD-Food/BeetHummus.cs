...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BeetHummus" item. 
    ...
    [LocDisplayName("Beet Hummus")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the BeetHummus is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BeetHummus".</para>
    ...
    public partial class BeetHummusRecipe : RecipeFamily
    {
        public BeetHummusRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Beet Hummus"
