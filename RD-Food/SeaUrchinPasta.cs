...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "SeaUrchinPasta" item. 
    ...
    [LocDisplayName("Sea Urchin Pasta")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the SeaUrchinPasta is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("We had to figure out something to do with urchins, and this is what we came up with! Enjoy!!")] //The tooltip description for the food item.
    public partial class SeaUrchinPastaItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 12, Fat = 27, Protein = 4, Vitamins = 0};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SeaUrchinPasta".</para>
    ...
    public partial class SeaUrchinPastaRecipe : RecipeFamily
    {
        public SeaUrchinPastaRecipe()
        {
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "SeaUrchinPasta"
