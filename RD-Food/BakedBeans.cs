...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Baked Beans")] // Defines the localized name of the item.
    [Weight(1)] // Defines how heavy the BakedBeans is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("That puppers finally spilled the beans")] //The tooltip description for the food item.
