...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawGoatMeatRecipe : RecipeFamily
    {
        public RawGoatMeatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepRawGoatMeat",  //noloc
                displayName: Localizer.DoStr("Prep Raw Goat Meat"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(GoatCarcassItem), 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
                ...
                {
                    new CraftingElement<RawGoatMeatItem>(2),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawGoatMeatRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Prep Raw Goat Meat"), recipeType: typeof(RawGoatMeatRecipe));
    ...
    [LocDisplayName("Prep Raw Goat Meat")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Prep Raw Goat Meat", createAsSubPage: true)]
    ...
    public partial class RawGoatMeatItem : FoodItem
    {

        /// <summary>The plural localization name for the food item.</summary>
        public override LocString DisplayNamePlural     => Localizer.DoStr("Prep Raw Goat Meat");
