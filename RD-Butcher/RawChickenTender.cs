...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawChickenTenderRecipe : RecipeFamily
    {
        public RawChickenTenderRecipe()
        {
            ...
            recipe.Init(
                name: "PrepRawChickenTender",  //noloc
                displayName: Localizer.DoStr("Prep Raw Chicken Tender"),
                ...
                {
                    new CraftingElement<RawChickentenderItem>(4),
    ...
    [LocDisplayName("Raw Chicken Tender")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Raw Chicken Tender", createAsSubPage: true)]
