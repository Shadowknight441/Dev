...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawAngusSteakRecipe : RecipeFamily
    {
        public RawAngusSteakRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepAngusCow",  //noloc
                displayName: Localizer.DoStr("Prep Angus Cow"),
                ...
                {
                    new CraftingElement<RawAngusSteakItem>(5),
            ...
            this.Initialize(displayText: Localizer.DoStr("Prep Angus Cow"), recipeType: typeof(RawAngusSteakRecipe));
    ...
    [LocDisplayName("Raw Angus Steak")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Raw Angus Steak", createAsSubPage: true)]
    ...
    public partial class RawAngusSteakItem : FoodItem
    {
        ...
        public override LocString DisplayNamePlural     => Localizer.DoStr("Raw Angus Steak");
