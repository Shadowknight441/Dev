...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawChickenRecipe : RecipeFamily
    {
        public RawChickenRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepRawChicken",  //noloc
                displayName: Localizer.DoStr("Prep Raw Chicken"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawChickenRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Prep Raw Chicken"), recipeType: typeof(RawChickenRecipe));
    ...
    [LocDisplayName("Prep Raw Chicken")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Prep Raw Chicken", createAsSubPage: true)]
    ...
    public partial class RawChickenItem : FoodItem
    {

        /// <summary>The plural localization name for the food item.</summary>
        public override LocString DisplayNamePlural     => Localizer.DoStr("Prep Raw Chicken");
