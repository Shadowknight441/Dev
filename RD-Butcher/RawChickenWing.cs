...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawChickenWingsRecipe : RecipeFamily
    {
        public RawChickenWingsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepRawChickenWings",  //noloc
                displayName: Localizer.DoStr("Prep Raw Chicken Wings"),
                ...
                {
                    new CraftingElement<RawChickenWingItem>(6),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawChickenWingsRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Raw Chicken Wing"), recipeType: typeof(RawChickenWingsRecipe));
    ...
    [LocDisplayName("Raw Chicken Wing")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Raw Chicken Wing", createAsSubPage: true)]
    ...
    public partial class RawChickenWingItem : FoodItem
    {
        ...
        public override LocString DisplayNamePlural     => Localizer.DoStr("Raw Chicken Wing");
