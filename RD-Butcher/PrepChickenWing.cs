...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawChickenWingRecipe : RecipeFamily
    {
        public RawChickenWingRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawChickenWingRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Raw Chicken Wing"), recipeType: typeof(RawChickenWingRecipe));
