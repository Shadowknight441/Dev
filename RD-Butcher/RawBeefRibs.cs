...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawBeefRibsRecipe : RecipeFamily
    {
        public RawBeefRibsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepBreefRibs",  //noloc
                displayName: Localizer.DoStr("Prep Beef Ribs"),
                ...
                {
                    new CraftingElement<RawBeefRibsItem>(5),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawBeefRibsRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Prep Beef Ribs"), recipeType: typeof(RawBeefRibsRecipe));
    ...
    [LocDisplayName("Raw Beef Ribs")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Raw Beef Ribs", createAsSubPage: true)]
