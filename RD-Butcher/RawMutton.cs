...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawMuttonRecipe : RecipeFamily
    {
        public RawMuttonRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrepRawMutton",  //noloc
                displayName: Localizer.DoStr("Prep Raw Mutton"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(SheepCarcassItem), 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
                ...
                {
                    new CraftingElement<RawMuttonItem>(3),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawMuttonRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Raw Mutton"), recipeType: typeof(RawMuttonRecipe));
    ...
    [LocDisplayName("Raw Mutton")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the RawMeat is.
    [Ecopedia("Food", "Raw Mutton", createAsSubPage: true)]
