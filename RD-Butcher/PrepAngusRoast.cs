...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PrepRawAngusRoastRecipe : RecipeFamily
    {
        public PrepRawAngusRoastRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PrepRawAngusRoastRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Prep Angus Roast"), recipeType: typeof(PrepRawAngusRoastRecipe));
