...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawRabbitRecipe : RecipeFamily
    {
        public RawRabbitRecipe()
        {
            ...
            recipe.Init(
                name: "PrepRawRabbit",  //noloc
                displayName: Localizer.DoStr("Prep Raw Rabbit"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(RabbitCarcassItem), 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
                ...
                {
                    new CraftingElement<RawRabbitItem>(6),
            ...
            this.Initialize(displayText: Localizer.DoStr("Raw Rabbit"), recipeType: typeof(RawRabbitRecipe));
    ...
    [Weight(10)] // Defines how heavy the RawMeat is.
