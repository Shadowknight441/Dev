...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Slaughter Sheep".</para>
    ...
    public partial class SlaughterSheepRecipe : RecipeFamily
    {
        public SlaughterSheepRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SlaughterSheepRecipe), start: 2, skillType: typeof(RancherSkill));
    ...
    [LocDisplayName("Slaughter Sheep")] // Defines the localized name of the item.
