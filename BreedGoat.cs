...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BreedGoatRecipe : RecipeFamily
    {
        public BreedGoatRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BreedGoatRecipe), start: 5, skillType: typeof(HuntingSkill));
    ...
    /// <summary>
    /// <para>Server side item definition for the "BreedGoat" item.</para>
    ...
    [LocDisplayName("Breed Goat")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy Board is.
    [Ecopedia("Items", "Food", createAsSubPage: true)]
    [Tag("Breed Goat")]
    [Tag("Goat Carcass")]
    [LocDescription("The future generation of the Goat family")] //The tooltip description for the item.
    public partial class BreedGoatItem : Item
    {
