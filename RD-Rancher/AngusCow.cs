...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AngusCowRecipe : RecipeFamily
    {
        public AngusCowRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AngusCowRecipe), start: 5, skillType: typeof(RancherSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "AngusCow"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Angus Cow"), recipeType: typeof(AngusCowRecipe));
    ...
    [LocDisplayName("Angus Cow")] // Defines the localized name of the item.
