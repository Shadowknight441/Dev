...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Pig".</para>
    ...
    [LocDisplayName("Pig")] // Defines the localized name of the item.
    [Weight(2500)] // Defines how heavy Board is.
    [Ecopedia("Items", "Product", createAsSubPage: true)]
    [Tag("Pig")]
    [Tag("Pig")]
    [LocDescription("A Pig you can breed purley for meat production")] //The tooltip description for the item.
