...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Slaughter Rabbit".</para>
    ...
    [LocDisplayName("Slaughter Rabbit")] // Defines the localized name of the item.
