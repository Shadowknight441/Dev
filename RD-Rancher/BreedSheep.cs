...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BreedSheepRecipe : RecipeFamily
    {
        public BreedSheepRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BreedSheepRecipe), start: 5, skillType: typeof(RancherSkill));
    ...
    public partial class BreedSheepItem : Item
    {
