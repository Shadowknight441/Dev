...
namespace Eco.Mods.TechTree
{
    ...
    public partial class MilkCowRecipe : RecipeFamily
    {
        public MilkCowRecipe()
        {
            ...
            recipe.Init(
                name: "MilkCow",  //noloc
                displayName: Localizer.DoStr("Milk Cow"),
                ...
                {
                    new CraftingElement<CowMilkItem>(3)
                });
            ...
            this.Initialize(displayText: Localizer.DoStr("Milk Cow"), recipeType: typeof(MilkCowRecipe));
    ...
    [LocDisplayName("Cow Milk")] // Defines the localized name of the item.
