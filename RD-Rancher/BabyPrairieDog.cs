...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "BabyPrairieDog" item.</para>
    ...
    [LocDisplayName("Baby Prairie Dog")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy Baby Hare is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [LocDescription("A Baby Prairie Dog.")] //The tooltip description for the item.
