...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "AngusCowCarcass" item.</para>
    ...
    [LocDisplayName("Angus Cow Carcass")] // Defines the localized name of the item.
    [Weight(2500)] // Defines how heavy BabyBison is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [LocDescription("A Cow Body.")] //The tooltip description for the item.
