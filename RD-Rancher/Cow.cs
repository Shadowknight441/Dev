...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Cow" item.</para>
    ...
    [LocDisplayName("Cow")] // Defines the localized name of the item.
    [Weight(2500)] // Defines how heavy BabyBison is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [LocDescription("A Cow")] //The tooltip description for the item.
