...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "DomesticateHare".</para>
    ...
    public partial class DomesticateHareRecipe : RecipeFamily
    {
        public DomesticateHareRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<Rabbittem>(1),
                });
            ...
            this.Initialize(displayText: Localizer.DoStr("Domesticate Hare"), recipeType: typeof(DomesticateHareRecipe));
