...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Angus Cow".</para>
    ...
    public partial class DairyCowRecipe : RecipeFamily
    {
        public DairyCowRecipe()
        {
            ...
            recipe.Init(
                name: "DairyCow",  //noloc
                displayName: Localizer.DoStr("Dairy Cow"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(DairyCowRecipe), start: 5, skillType: typeof(RancherSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "AngusCow"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Dairy Cow"), recipeType: typeof(DairyCowRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "AngusCow" item.</para>
    ...
    [LocDisplayName("Dairy Cow")] // Defines the localized name of the item.
