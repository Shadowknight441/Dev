...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Hay Bale".</para>
    ...
    public partial class HayBaleRecipe : RecipeFamily
    {
        public HayBaleRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(WheatItem, 7, typeof(FarmingSkill)), //noloc
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Hay Bale"
    ...
    /// <summary>
    /// <para>Server side item definition for the "Hay Bale" item.</para>
    ...
    [Tag("Bale")]
    [Tag("Usable Bedding")]
    [LocDescription("A bale that can be used in the barn for bedding.")] //The tooltip description for the item.
