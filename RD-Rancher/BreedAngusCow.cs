...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Products", subPageName: "Breed Angus Cow")]
    public partial class BreedAngusCowRecipe : RecipeFamily
    {
        public BreedAngusCowRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BreedAngusCow",  //noloc
                ...
                {
                    new IngredientElement(typeof(AngusCowItem), 2, true),
                ...
                {
                    new CraftingElement<AngusCowItem>(3)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BreedAngusCowRecipe), start: 5, skillType: typeof(RancherSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "BreedAngusCow"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Breed Angus Cow"), recipeType: typeof(BreedAngusCowRecipe));
    ...
    [LocDisplayName("Breed Angus Cow")] // Defines the localized name of the item.
    ...
    public partial class BreedAngusCowItem : Item
    {
